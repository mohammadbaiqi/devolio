            ...
            <div className="flex flex-col sm:flex-row gap-12 lg:gap-24 lg:pt-4">
              <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <a href={SOCIAL_LINKS[2].href} target="_blank" rel="noreferrer" className="flex items-center gap-3 text-white/80 hover:text-white transition-colors">
          ...
          <div className="mt-16 pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4 text-white/40 text-sm">
            ...
            <div className="flex items-center gap-6">
              {LEGAL_LINKS.map((link) => (
                <NavLink key={link.label} to={link.to} className="hover:text-white transition-colors">
                  {link.label}
                </NavLink>
              ))}
            </div>
